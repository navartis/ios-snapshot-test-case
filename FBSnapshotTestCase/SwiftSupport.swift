...
public extension FBSnapshotTestCase {
    func FBSnapshotVerifyView(_ view: UIView, identifier: String? = nil, suffixes: NSOrderedSet = FBSnapshotTestCaseWithoutSuffixes(), perPixelTolerance: CGFloat = 0, overallTolerance: CGFloat = 0, file: StaticString = #file, line: UInt = #line) {
    ...
    func FBSnapshotVerifyLayer(_ layer: CALayer, identifier: String? = nil, suffixes: NSOrderedSet = FBSnapshotTestCaseWithoutSuffixes(), perPixelTolerance: CGFloat = 0, overallTolerance: CGFloat = 0, file: StaticString = #file, line: UInt = #line) {
  ...
  private func FBSnapshotVerifyViewOrLayer(_ viewOrLayer: AnyObject, identifier: String? = nil, suffixes: NSOrderedSet = FBSnapshotTestCaseDefaultSuffixes(), perPixelTolerance: CGFloat = 0, overallTolerance: CGFloat = 0, file: StaticString = #file, line: UInt = #line) {
    ...
    guard suffixes.count == 0 else {
        for suffix in suffixes {
            FBSnapshotVerifyViewOrLayer(viewOrLayer, identifier: identifier, suffix: suffix as? String, perPixelTolerance: perPixelTolerance, overallTolerance: overallTolerance, file: file, line: line)
        }
        return
    }
    
    FBSnapshotVerifyViewOrLayer(viewOrLayer, identifier: identifier, suffix: nil, perPixelTolerance: perPixelTolerance, overallTolerance: overallTolerance, file: file, line: line)

  }
    
    private func FBSnapshotVerifyViewOrLayer(_ viewOrLayer: AnyObject, identifier: String? = nil, suffix: String? = nil, perPixelTolerance: CGFloat = 0, overallTolerance: CGFloat = 0, file: StaticString = #file, line: UInt = #line) {
